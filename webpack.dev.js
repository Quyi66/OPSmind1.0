...
module.exports = (env, argv) => {
  // 代理服务器配置
  const PROXY_TARGET = process.env.PROXY_TARGET || "https://192.168.1.230";
      ...
      onListening: function (devServer) {
        ...
        const host =
          devServer.options.host === "0.0.0.0"
            ? "localhost"
            : devServer.options.host;

        console.log("\n🚀 开发服务器已启动:");
        console.log(`   本地访问: https://${host}:${port}/oplus/base/`);
        console.log(`   网络访问: https://10.1.8.185:${port}/oplus/base/`);
        console.log("");
      },
    },
