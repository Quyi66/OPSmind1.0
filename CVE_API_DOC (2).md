...
| 4 | /affected-hosts/{cveId} | GET | 查询CVE受影响的主机列表 |
...
**GET** `/api/vap/v2/cve/affected-hosts/{cveId}`

### 功能说明

根据CVE编号查询受该漏洞影响的所有主机资产，返回去重后的主机列表。
...
```
GET /api/vap/v2/cve/affected-hosts/CVE-2025-26597
```
...
|------|------|------|
| hostId | string | 主机ID |
| hostKey | string | 主机标识Key |
| osDistro | string | 操作系统发行版 |
| osVersion | string | 操作系统版本 |
| patchId | string | 补丁ID |
| affectedPkgs | string | 受影响的包列表 |
| severity | string | 漏洞严重等级 |
| patchStatus | string | 补丁状态 |
| scanDate | datetime | 扫描时间 |
  ...
  "hosts": [
    {
      ...
      "osDistro": "Red Hat Enterprise Linux",
      "osVersion": "8.6",
      "patchId": "RHSA-2025:0863",
      "affectedPkgs": "tigervnc-1.12.0-5.el8",
      "severity": "important",
      "patchStatus": "pending",
      "scanDate": "2025-02-01T10:30:00"
    },
    {
      "hostId": "host-002",
      ...
      "osDistro": "Kylin",
      "osVersion": "V10 SP3",
      "patchId": "KYSA-202502-0123",
      "affectedPkgs": "tigervnc-1.11.0-3.ky10",
      "severity": "important",
      "patchStatus": "applied",
      "scanDate": "2025-02-01T11:00:00"
    },
    {
      "hostId": "host-003",
      "hostKey": "192.168.1.102",
      "osDistro": "Red Hat Enterprise Linux",
      "osVersion": "9.0",
      "patchId": "",
      "affectedPkgs": "xorg-x11-server-1.20.11-1.el9",
      "severity": "important",
      "patchStatus": "pending",
      "scanDate": "2025-02-01T09:15:00"
    }
  ]
}
```
