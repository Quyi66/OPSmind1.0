//HEAD 
(function(app) {
try { app = angular.module("oplus.app"); }
catch(err) { app = angular.module("oplus.app", []); }
app.run(["$templateCache", function($templateCache) {
"use strict";

$templateCache.put("app/modules/app/applet-config-access.component.html","<div>\n" +
...
$templateCache.put("app/modules/app/applet-help.html","<style>\n" +
    "    [ui-view=navbar] {\n" +
    "        display: none;\n" +
    "    }\n" +
    "</style>\n" +
...
$templateCache.put("app/modules/app/applet-item.component.html","<div class=\"op-hover-trigger opx-applet-item js-dropdown-click-to-close\">\n" +
...
$templateCache.put("app/modules/app/applet-list.component.html","<div ng-if=\"$ctrl.ctrlError\" class=\"h-100 p-5\">\n" +
    ...
    "<!--                                ng-click=\"tag.status=!tag.status;$ctrl.setTag(tag)\"-->\n" +
    "<!--                                value=\"{{tag}}\">-->\n" +
    "<!--                            {{tag.name}}-->\n" +
    "<!--                        </button>-->\n" +
    "                    </li>\n" +
...
$templateCache.put("app/modules/app/applet-mgmt-datamodels.html","<div class=\"opx-layout-vflex\" uaa-is-authenticated uaa-deny-message=\"{{'common.uaa.no_permission' | translate}}\">\n" +
...
$templateCache.put("app/modules/app/applet-mgmt-datasets-edit.html","<dataset-edit applet-code=\"$ctrl.appletCode\" edit-state=\"'app.appman.dataset.edit'\"></dataset-edit>\n" +
    "")

$templateCache.put("app/modules/app/applet-mgmt-datasets.html","<div class=\"opx-layout-vflex\" ui-view=\"dts_dataset_list\">\n" +
    "    <nav class=\"navbar navbar-light\">\n" +
    "        <div class=\"navbar-nav\">\n" +
    "            <ol class=\"breadcrumb\">\n" +
...
$templateCache.put("app/modules/app/applet-mgmt-datasource.html","<datasource-list ui-view-url=\"'aplMgmtDatasetsView'\" dataset-state=\"'app.appman.dataset'\" style=\"height: 100%;\"></datasource-list>")

$templateCache.put("app/modules/app/applet-mgmt-jobs.html","<div class=\"opx-layout-vflex\">\n" +
    "    <div class=\"opx-flex-fill\">\n" +
    "        <job-list show-applet=\"true\" applet-code=\"$ctrl.appletCode\"></job-list>\n" +
    "    </div>\n" +
    "</div>")

$templateCache.put("app/modules/app/applet-mgmt-pages.html","<div class=\"opx-layout-vflex\" ui-view=\"app_mgmt_page_view\">\n" +
    "    <nav class=\"navbar navbar-light\">\n" +
    "        <div class=\"opx-navbar-title\">{{'udp.page.title' | translate}}</div>\n" +
    "        <div class=\"navbar-nav ms-auto\">\n" +
    "            <div class=\"nav-item me-2\">\n" +
    "<!--                <a class=\"btn btn-outline-primary\" ui-sref=\"app.appman.page.create\"-->\n" +
...
$templateCache.put("app/modules/app/applet-mgmt.html","<div class=\"opx-layout-vflex\">\n" +
    "    <nav class=\"navbar navbar-light\">\n" +
    "        <div class=\"navbar-nav\">\n" +
    "            <ol class=\"breadcrumb\">\n" +
...
$templateCache.put("app/modules/app/applet-setting.html","<div class=\"opx-layout-hflex opx-flex-fill scroll-y\">\n" +
    ...
    "                <!--                        ng-click=\"appSettingVm.cancel($event)\" data-translate=\"common.entity.action.cancel\"> 取消-->\n" +
    "                <!--                </button>-->\n" +
    "            </div>\n" +
    "        </nav>\n" +
    ...
    "                            <!--                                <udp-page-and-param-config page-id=\"appSettingVm.applet.entry\" params-json=\"appSettingVm.applet.entryParams\"></udp-page-and-param-config>-->\n" +
    "                            <!--                            </div>-->\n" +
    "                            <div class=\"form-group\" ng-if=\"appSettingVm.entryType === 'udp-page'\">\n" +
    ...
    "                        </div>\n" +
    "                        <!--                        <div class=\"form-group\">-->\n" +
    "                        <!--                            <label class=\"control-label\" data-translate=\"app.setting.helpDoc\">帮助文档</label>-->\n" +
    "                        <!--                            <div class=\"form-control-wrapper\">-->\n" +
    "                        <!--                                <div class=\"border p-2 rounded w-100 d-flex align-items-center\">-->\n" +
    "                        <!--                                    <a class=\"text-primary me-auto\"-->\n" +
    "                        <!--                                       ui-sref=\"app.applet_help({appletCode:appSettingVm.applet.name})\"-->\n" +
    "                        <!--                                       target=\"_blank\">{{appSettingVm.getHelpDocName()}}</a>-->\n" +
    "                        <!--                                    <button class=\"btn btn-default btn-sm ms-3\" type=\"file\" ngf-select-->\n" +
    "                        <!--                                            ngf-pattern=\"'.pdf'\"-->\n" +
    "                        <!--                                            ngf-accept=\"'application/pdf'\"-->\n" +
    "                        <!--                                            ngf-change=\"appSettingVm.uploadHelpDoc($file)\">-->\n" +
    "                        <!--                                        <i class=\"fa fa-upload\"></i> {{'app.setting.uploadDoc' | translate}}-->\n" +
    "                        <!--                                    </button>-->\n" +
    "                        <!--                                    <button class=\"btn btn-sm btn-default ms-3 opx-btn-icon opx-btn-flat\" type=\"button\"-->\n" +
    "                        <!--                                            ng-click=\"appSettingVm.removeHelpDoc()\"-->\n" +
    "                        <!--                                            title=\"{{'app.setting.delDoc.title' | translate}}\"-->\n" +
    "                        <!--                                            ng-if=\"appSettingVm.applet.helpDocUrl\">-->\n" +
    "                        <!--                                        <i class=\"fa fa-times\"></i>-->\n" +
    "                        <!--                                    </button>-->\n" +
    "                        <!--                                </div>-->\n" +
    "                        <!--                                <p class=\"help-block\" data-translate=\"app.setting.docInfo\">注意：只支持pdf格式文件</p>-->\n" +
    "                        <!--                            </div>-->\n" +
    "                        <!--                        </div>-->\n" +
    "                    </uib-tab>\n" +
    "                    <uib-tab>\n" +
...
$templateCache.put("app/modules/app/helper/applet-selector.html","<div ng-if=\"$ctrl.options.viewAs!=='list'\">\n" +
...
$templateCache.put("app/modules/app/window/applet-content.component.html","<div ng-class=\"$ctrl.applet.setting.nav.position==='left'?'opx-layout-hflex':'opx-layout-vflex'\">\n" +
    ...
    "                </div>\n" +
    "<!--                <div class=\"opx-treenav-item\" ng-class=\"{'with-space':$ctrl.useWindowUI}\"-->\n" +
    "<!--                     ng-if=\"$ctrl.applet.helpDocUrl\">-->\n" +
    "<!--                    <a ui-sref=\"app.applet_help({appletCode:$ctrl.applet.name})\"-->\n" +
    "<!--                       target=\"_blank\"><i-->\n" +
...
$templateCache.put("app/modules/app/window/applet-dock.component.html","<ul class=\"navbar-nav opx-win-dock\">\n" +
...
$templateCache.put("app/modules/app/window/applet-window-modal.html","<div class=\"modal-header\" ng-class=\"{'bg-dark':$ctrl.applet.theme==='dark'}\" ng-dblclick=\"$ctrl.restoreOrMaxWindow()\">\n" +
...
$templateCache.put("app/modules/app/window/desktop.component.html","<div class=\"opx-win-desktop\">\n" +
...
$templateCache.put("app/modules/app/window/status-bar.component.html","<ul class=\"navbar-nav\" ng-switch=\"$ctrl.currentUser.isAuthenticated\">\n" +
    "<!--   <li class=\"nav-item dropdown\" ng-if=\"$ctrl.currentUser.isAuthenticated && !$root.$global.isAdminUI\">-->\n" +
    "<!--        <a class=\"nav-link\" ng-click=\"$ctrl.openSearch('search')\"><i class=\"fa fa-search\"></i> </a>-->\n" +
    "<!--    </li>-->\n" +
    ...
    "            </a>\n" +
    "            <!-- =============== Admin Features in Tenant Scope ================-->\n" +
    "            <!-- <li class=\"dropdown-item\" uaa-has-permission=\"sysadmin:user:*\">\n" +
    ...
    "                </a>\n" +
    "            </li> -->\n" +
    "            <!-- =============== Admin Features in System Scope ================-->\n" +
...
$templateCache.put("app/modules/app/window/taskbar.component.html","<nav ng-style=\"{'background-color':$ctrl.barBackgroundColor}\"\n" +
